...
import lineage2.gameserver.model.quest.campaign.DynamicQuest;
...
{
	static final Logger _log = LoggerFactory.getLogger(MemorialService.class);
	private static final int QUEST_ID = 3;
	private static final String START_TIME = "00 23 * * Mon"; // "*/10 * * * *" every 10 minutes
	private static final int MIN_LEVEL = 40;
	private static final int MAX_LEVEL = 99;
	private static final int DURATION = 1800; // 180 = 3 minutes duration
	...
	private final OnSocialActionListenerImpl _action = new OnSocialActionListenerImpl();
	...
	private final class OnSocialActionListenerImpl implements OnSocialActionListener
	{
		...
		public void onSocialAction(Player player, GameObject target, Action action)
		{
			...
			if (target != null && target.isNpc() && (dist < 70))
			{
